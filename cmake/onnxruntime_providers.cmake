...
if (onnxruntime_USE_CUDA)
  ...
  onnxruntime_add_shared_library_module(onnxruntime_providers_cuda ${onnxruntime_providers_cuda_src} "${ONNXRUNTIME_ROOT}/core/dll/onnxruntime.rc")
  if (onnxruntime_REDUCED_OPS_BUILD)
    add_op_reduction_include_dirs(onnxruntime_providers_cuda)
  endif()

  target_compile_definitions(onnxruntime_providers_cuda PRIVATE VER_MAJOR=${VERSION_MAJOR_PART})
  target_compile_definitions(onnxruntime_providers_cuda PRIVATE VER_MINOR=${VERSION_MINOR_PART})
  target_compile_definitions(onnxruntime_providers_cuda PRIVATE VER_BUILD=${VERSION_BUILD_PART})
  target_compile_definitions(onnxruntime_providers_cuda PRIVATE VER_PRIVATE=${VERSION_PRIVATE_PART})
  target_compile_definitions(onnxruntime_providers_cuda PRIVATE VER_STRING=\"${VERSION_STRING}\")
...
if (onnxruntime_USE_TENSORRT)
  ...
  onnxruntime_add_shared_library_module(onnxruntime_providers_tensorrt ${onnxruntime_providers_tensorrt_cc_srcs} "${ONNXRUNTIME_ROOT}/core/dll/onnxruntime.rc")
  ...
  target_compile_definitions(onnxruntime_providers_tensorrt PRIVATE VER_MAJOR=${VERSION_MAJOR_PART})
  target_compile_definitions(onnxruntime_providers_tensorrt PRIVATE VER_MINOR=${VERSION_MINOR_PART})
  target_compile_definitions(onnxruntime_providers_tensorrt PRIVATE VER_BUILD=${VERSION_BUILD_PART})
  target_compile_definitions(onnxruntime_providers_tensorrt PRIVATE VER_PRIVATE=${VERSION_PRIVATE_PART})
  target_compile_definitions(onnxruntime_providers_tensorrt PRIVATE VER_STRING=\"${VERSION_STRING}\")
